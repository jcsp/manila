...
class CephFSNativeDriverTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_object(cephfs, "ceph_volume_client",
                         MockVolumeClientModule)
        self.mock_object(cephfs, "ceph_module_found", True)
    ...
    def test_allow_access_wrong_type(self):
        self.assertRaises(exception.InvalidShareAccess,
                          ...
                          self._context, self._share_instance, {
                              'access_level': constants.ACCESS_LEVEL_RW,
                              'access_type': 'RHUBARB',
                              'access_to': 'alice'
                          })
    ...
    def test_shrink_share_full(self):
        ...
        vc.mock_used_bytes = (units.Gi * self._share_instance['size'])

        self.assertRaises(exception.ShareShrinkingPossibleDataLoss,
                          self._driver.shrink_share,
                          self._share_instance, new_size_gb, None)
    ...
    def test_module_missing(self):
        cephfs.ceph_module_found = False
        cephfs.ceph_volume_client = None
